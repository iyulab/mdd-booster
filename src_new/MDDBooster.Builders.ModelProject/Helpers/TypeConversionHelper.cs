...
public static class TypeConversionHelper
{
    ...
    public static bool IsEnumField(MDDField field, MDDDocument document)
    {
        ...
        if (field.BaseField.Type.Equals("enum", StringComparison.OrdinalIgnoreCase))
            return true;
        ...
        return document.Enums.Any(e => e.BaseEnum.Name.Equals(field.BaseField.Type, StringComparison.OrdinalIgnoreCase));
    }
    ...
    public static string GetEnumTypeName(MDDField field, MDDDocument document)
    {
        ...
        var enumByType = document.Enums.FirstOrDefault(e =>
            e.BaseEnum.Name.Equals(field.BaseField.Type, StringComparison.OrdinalIgnoreCase));
